    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        switch (call.method) {
            case "checkPermissionStatus":
                @PermissionStatus final int permissionStatus = LocationPermissionsPlugin.checkPermissionStatus(applicationContext, (int) call.arguments);
                result.success(permissionStatus);
                break;
            case "checkServiceStatus":
                @ServiceStatus final int serviceStatus = LocationPermissionsPlugin.checkServiceStatus(applicationContext);
